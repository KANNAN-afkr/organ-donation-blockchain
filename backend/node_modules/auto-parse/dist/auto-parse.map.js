...
function parseDateTimeString(str, options) {
  ...
  if (m) {
    ...
    let [, , , year2, h2, min2, sec2, ap] = m;
    var date = new Date(Number(year2), month - 1, day);
    if (h2 !== void 0) {
      h2 = Number(h2);
      if (ap) {
        ap = ap.toLowerCase();
      ...
      date.setHours(h2, Number(min2), Number(sec2 || 0), 0);
    }
    return date;
  }
...
//# sourceMappingURL=auto-parse.map.js.map
